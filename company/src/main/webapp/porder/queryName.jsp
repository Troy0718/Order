		...
		<div id="shop_main" class="row">
			<div class="col-md-9 col-sm-8">
				...
				<form action="querySum.jsp" method="post"  role="form"   class="form-horizontal">
					<div class="col-md-12"><h3 text-align="right">請輸入姓名查詢訂單紀錄</h3></div>
        	<div class="form-group">
                  <label class="col-md-2 control-label">姓名：</label>
                  <div class="col-md-4">
                    <input type="name" name="name" value="" class="form-control validate[require]" placeholder="" >                   
                  </div>
